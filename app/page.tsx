...
export const metadata: Metadata = {
  ...
  description:
    `한국 주식 투자자를 위한 무료 AI 주식 분석 뉴스레터. 매일 오전 7시 30분, AI가 30개 기술적 지표로 분석한 KOSPI·KOSDAQ 3종목을 이메일로 제공합니다. 웹사이트에서는 ${siteConfig.themeCountFloor}+ 테마 생명주기와 관련 종목 분석도 확인할 수 있습니다.`,
  keywords: [
    'StockMatrix',
    'AI 주식 분석',
    '무료 주식 뉴스레터',
  ...
  openGraph: {
    title: 'StockMatrix | 무료 AI 주식 분석 뉴스레터 · KOSPI·KOSDAQ 3종목 분석',
    description:
      `매일 오전 7시 30분, AI가 KOSPI·KOSDAQ 3종목을 분석해 무료 이메일로 제공하는 한국 주식 뉴스레터. 웹사이트에서 ${siteConfig.themeCountFloor}+ 테마 분석 제공`,
  ...
  twitter: {
    ...
    description:
      `매일 오전 7시 30분, KOSPI·KOSDAQ 3종목을 AI로 분석해 무료 이메일로 제공하는 한국 주식 뉴스레터. 웹사이트에서 ${siteConfig.themeCountFloor}+ 테마 분석 제공`,
...
export default function HomePage() {
  const homePageSchema = {
    ...
    description:
      `한국 주식 투자자를 위한 무료 AI 주식 분석 뉴스레터. 매일 오전 7시 30분, AI가 30개 기술적 지표로 분석한 KOSPI·KOSDAQ 3종목을 이메일로 제공하며, 웹사이트에서는 ${siteConfig.themeCountFloor}+ 테마 생명주기 분석을 확인할 수 있습니다.`,
    url: siteConfig.domain,
    inLanguage: 'ko-KR',
