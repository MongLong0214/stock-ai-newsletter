...
const HOOK_TRIGGERS = `
## 강력한 후킹 트리거 (필수 2개 이상 조합)

1. **손실회피형** (가장 강력): "실패하는", "손실 보는", "함정", "실수", "망하는", "피해야 할"
2. **구체적 숫자**: "3가지", "5단계", "90%", "5초", "TOP 10"
3. **질문/딜레마형**: "vs", "정답일까", "뭐가 맞을까", "언제 사야"
4. **타이밍형**: "매수 타이밍", "진입 시점", "조건", "기준"
5. **희소성형**: "아무도 안 알려주는", "숨겨진", "진짜"
6. **해결형**: "고치는", "극복", "찾는법", "구별법"

### 후킹 조합 공식
- [손실회피 + 숫자] = 최강: "초보 90%가 손실 보는 RSI 함정 3가지"
- [질문형 + 비교] = 강력: "분할매수 3번 vs 5번 뭐가 정답일까"
- [희소성 + 숫자] = 강력: "아무도 안 알려주는 배당주 조건 5가지"
`;
...
const TOPIC_AREAS = `
## 주제 영역 (topicArea) - 8개 중 최소 4개 분산 필수

| 영역 | 핵심 키워드 |
|------|------------|
| technical | RSI, MACD, 볼린저밴드, 차트, 지표, 골든크로스 |
| value | PER, PBR, ROE, 가치투자, 저평가, 배당 |
| strategy | 분할매수, 손절, 익절, 포지션, 매매법 |
| market | 금리, 환율, 코스피, 외국인, 수급, 업종 |
| discovery | 종목발굴, 스크리닝, 테마주, 성장주, ETF |
| psychology | 뇌동매매, 멘탈, 손실심리, FOMO, 극복 |
| education | 초보, 입문, 용어, 수수료, 세금, 계좌 |
| execution | 호가창, 체결, 단타, 스윙, 타이밍, 진입 |
`;
