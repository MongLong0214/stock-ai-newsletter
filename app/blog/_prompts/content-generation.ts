...
**제목(title) 최종 점검 — 사실형·인용가능(금융 YMYL):**
- 종목/테마/키워드 + 구체적 사실(종목 수, 범주, 기준 시점)이 제목 앞부분에 있는가?
- 낚시·공포·과장 표현을 완전히 배제했는가? (금지: "확률 87%", "안 보면 손해", "고점에 물립니다", "지금 아니면", "~썰", "충격", 물음표 낚시)
- 검색결과·AI 답변에서 무엇에 관한 글인지 제목만으로 즉시 이해되는가?
- AI(LLM)가 그대로 인용할 만큼 검증가능한 사실 중심인가?
- 대괄호 레이블, AI 티나는 표현 없는가?
- 좋은 예: "부유식 SMR 관련주 7종목 — 해상원전 수혜주 정리 (2026.08)"

\`\`\`json
{
  "title": "사실형 제목: [키워드/종목·테마] + 구체 범주/개수 + (연·월). 낚시·과장 금지 (예: '부유식 SMR 관련주 7종목 — 해상원전 수혜주 정리 (2026.08)')",
  "description": "글의 핵심 가치를 요약 (150-200자)",
  "metaTitle": "검색 결과 제목 (50-60자, 키워드 앞부분 + 핵심 사실 요약. 낚시·과장 금지)",
