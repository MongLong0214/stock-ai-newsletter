...
export const metadata: Metadata = {
  title: '구독 취소',
  description: `${siteConfig.serviceName} AI 주식 분석 뉴스레터 구독을 취소합니다. 언제든지 다시 구독하실 수 있습니다.`,
  alternates: {
    canonical: `${siteConfig.domain}/unsubscribe`,
  },
  openGraph: {
    title: `${siteConfig.serviceName} 구독 취소`,
    description: `${siteConfig.serviceName} 뉴스레터 구독 취소`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${siteConfig.serviceName} 구독 취소`,
      },
    ],
  },
  twitter: {
