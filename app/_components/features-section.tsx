    ...
    <section className="py-20 lg:py-24 px-6 lg:px-8 relative" aria-labelledby="features-heading">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          className="text-4xl sm:text-5xl md:text-6xl font-extralight mb-14 lg:mb-16 text-center text-emerald-500/80 tracking-tight"
        >
          3개의 LLM 모델
        </motion.h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="relative p-8 lg:p-10 rounded-3xl glass-morphism border border-emerald-500/20 transition-all duration-700 ease-out-expo group-hover:border-emerald-500/40 group-focus:border-emerald-500/40 group-hover:shadow-[0_0_40px_rgba(16,185,129,0.1)] overflow-hidden h-full flex flex-col">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <h3 className="text-3xl lg:text-4xl font-normal mb-4 text-emerald-300 tracking-tight group-hover:text-emerald-200 transition-colors duration-500">
                    {feature.title}
                  </h3>
                  <p className="text-sm lg:text-base text-slate-300 font-light leading-relaxed tracking-wide group-hover:text-slate-300 transition-colors duration-500 min-h-[3rem]">
                    {feature.description}
                  </p>
                </div>
