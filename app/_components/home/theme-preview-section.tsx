              ...
              {MOCK_THEMES.map((theme, i) => {
                ...
                return (
                  <Link
                    key={theme.name}
                    href="/themes"
                    className="block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black rounded-lg"
                  >
                    <motion.div
