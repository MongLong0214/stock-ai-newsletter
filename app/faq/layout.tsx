...
export const metadata: Metadata = {
  ...
  description:
    `${siteConfig.serviceName} AI 주식 분석 뉴스레터에 대해 자주 묻는 질문과 답변입니다. 무료 구독, 기술적 분석 지표, 서비스 이용 방법 등을 확인하세요.`,
  keywords: [
    `${siteConfig.serviceName} FAQ`,
    'AI 주식 분석',
    '무료 뉴스레터',
    '기술적 분석',
    'RSI',
  ...
  openGraph: {
    title: `FAQ - ${siteConfig.serviceName} AI 주식 분석`,
    description: '무료 AI 주식 분석 뉴스레터에 대한 자주 묻는 질문',
    type: 'website',
    url: `${siteConfig.domain}/faq`,
    locale: 'ko_KR',
    siteName: siteConfig.serviceName,
    images: [{ url: withOgImageVersion('/faq/opengraph-image'), width: 1200, height: 630, alt: `${siteConfig.serviceName} FAQ` }],
  },
  twitter: {
