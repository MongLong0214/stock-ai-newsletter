...
export default async function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Card 1 — Gauge Card (top-left, shifted) */}
        <div
          style={{
            position: 'absolute',
            top: '20px',
        ...
        {/* Card 2 — Activity Chart (mid-left) */}
        <div
          style={{
            position: 'absolute',
            top: '155px',
        ...
        {/* Card 3 — Active Themes (top-right, shifted) */}
        <div
          style={{
            position: 'absolute',
            top: '70px',
        ...
        {/* Card 4 — Theme Volume Table (top-right corner) */}
        <div
          style={{
            position: 'absolute',
            top: '5px',
        ...
        {/* Card 5 — Scatter Plot (bottom-left, shifted) */}
        <div
          style={{
            position: 'absolute',
            bottom: '0px',
        ...
        {/* Card 6 — Bar Chart (bottom-right, shifted) */}
        <div
          style={{
            position: 'absolute',
            bottom: '25px',
