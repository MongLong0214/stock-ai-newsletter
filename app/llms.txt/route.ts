...
- \`GET /api/tli/predictions?themeId={uuid}&phase=rising|hot|cooling\` — \`TLI_PREDICTIONS_V3_EXPOSURE_ENABLED=true\`일 때 theme_predictions_v3 챔피언 스냅샷 기반 pRise/CI/abstain 예측, 비활성화 시 dataSource=none fail-closed, phase는 2026-09-15 제거 예정 호환 필터
