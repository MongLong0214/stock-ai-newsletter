...
export function DetailLoading() {
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      {/* Animated background would go here but skipped for performance */}
              ...
              <div className="space-y-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex items-start gap-2">
                    <div className="h-3 w-3 bg-slate-800/50 rounded" />
                    <div className="flex-1 space-y-1">
                      <div className="h-4 w-full bg-slate-700/50 rounded" />
                      <div className="flex items-center gap-2">
                        <div className="h-3 w-16 bg-emerald-500/10 rounded" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-[600px] gap-4 sm:gap-6">
            ...
            <GlassCard className="p-6 h-full overflow-y-auto">
              <div className="animate-pulse">
                ...
                <div className="h-20 w-full bg-emerald-500/5 rounded-xl mb-6" />
                <div className="space-y-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center justify-between">
            ...
            <GlassCard className="p-6 h-full overflow-y-auto">
              <div className="animate-pulse">
                ...
                <div className="flex gap-1 mb-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="h-6 w-16 bg-slate-800/30 rounded" />
                  ))}
                </div>
                <div className="space-y-2">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
