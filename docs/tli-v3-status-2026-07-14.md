...
> ⚠️ **SUPERSEDED — 최신 상태는 `docs/tli-v3-status-2026-07-22.md`를 보라.**
> 이후 사건: 제헌절(7/17) 재지정 CI 사고 수정, 7/20 origin usable=198, study contract lock(시계 7/27 시작),
> gta-v2 라벨 배선(step 4.15), B-Abl 수집 활성화. 이 문서의 §3(cron)·§6(지도)·§9(성공 정의)는 계속 유효.
