...
export const faqData: FAQItem[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    answer:
      'StockMatrix는 한국 주식 투자자를 위한 무료 이메일 뉴스레터 서비스입니다. RSI, MACD, 이동평균 등 15종의 기술적 지표를 코드로 계산해 선정한 KOSPI·KOSDAQ 3종목의 분석 정보를 매일 오전 7시 30분 이메일로 제공합니다. 2024년 서비스 시작 이후 한국 개인 투자자들에게 참고용 무료 주식 정보를 제공하고 있습니다.',
    category: 'basic',
  },
  {
  ...
  },
  {
    ...
    answer:
      `매우 간단합니다. 뉴스레터 하단의 "구독 취소" 링크를 클릭하시면 즉시 구독이 해지됩니다. 별도의 로그인이나 복잡한 절차 없이 원클릭으로 취소 가능하며, 언제든 다시 구독하실 수 있습니다. ${siteConfig.serviceName}는 투자자의 선택을 존중하는 무료 뉴스레터로, 구독과 취소 모두 투명하고 쉽게 운영됩니다.`,
    category: 'service',
  },
  {
  ...
  },
  {
    ...
    answer:
      'StockMatrix의 주요 장점은 1) 완전 무료 (광고 없음), 2) 매일 오전 7시 30분 정시 발송 (장 시작 전), 3) 15종의 기술적 지표를 코드로 직접 계산, 4) 이메일로 편리하게 수신, 5) 5초면 구독 완료, 6) 언제든 구독 취소 가능입니다.',
    category: 'service',
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    answer:
      '현재 코드에서는 15종의 기술적 지표 계산 함수를 사용합니다. RSI(상대강도지수), MACD 히스토그램, 단순·지수이동평균, 이동평균 기울기, ATR, ADX, OBV 기울기, 거래량 비율·백분위, 전일 종가 대비 시가 갭, 52주 가격 위치, 연속 상승일, 추세 회귀, 최근 고점과의 거리를 직접 계산해 KOSPI와 KOSDAQ 종목의 참고 데이터를 만듭니다.',
    category: 'technical',
  },
  {
    question: 'AI 분석의 정확도는 어느 정도인가요?',
    answer:
      '주식 분석은 RSI, MACD, 이동평균 등 기술적 지표를 기반으로 한 참고 데이터입니다. 과거 가격과 거래량을 이용한 기술적 분석이므로 100% 정확한 예측은 불가능하며, 시장 상황, 뉴스, 정책 등 다양한 변수에 영향을 받습니다. 투자 뉴스레터의 분석 결과는 KOSPI, KOSDAQ 주식 투자 시 여러 판단 자료 중 하나로만 활용하시고, 반드시 본인의 추가 분석과 판단을 병행하시기 바랍니다.',
    category: 'technical',
  },
  {
    question: '분석 데이터는 어디서 가져오나요?',
    answer:
      '한국투자증권(KIS) 공식 시세 API로 수집한 거래소 데이터에서 시가·고가·저가·종가·거래량을 확보합니다. 이 가격·거래량 데이터로 RSI, MACD, 이동평균 등 15종의 기술적 지표를 코드로 직접 계산해 KOSPI·KOSDAQ 종목 분석을 위한 참고 데이터로 사용합니다.',
    category: 'technical',
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    answer:
      '아닙니다. StockMatrix는 매매 추천이나 투자 권유를 하지 않습니다. 금융투자협회에 등록되지 않은 정보 제공 서비스로, 15종의 기술적 지표를 코드로 계산한 분석 결과를 참고용 데이터로만 제공하는 무료 뉴스레터입니다. 모든 투자 결정과 그에 따른 책임은 투자자 본인에게 있습니다.',
    category: 'legal',
  },
  {
    question: '이 뉴스레터는 투자 권유나 추천인가요?',
    answer:
      `아닙니다. ${siteConfig.serviceName}는 투자 권유가 아닌 참고용 기술적 분석 데이터를 제공하는 무료 뉴스레터입니다. AI 주식 분석 결과는 투자 판단을 위한 여러 참고 자료 중 하나일 뿐이며, 최종 투자 결정과 그에 따른 손익은 투자자 본인의 책임입니다. KOSPI, KOSDAQ 주식 투자 시 반드시 본인의 판단과 추가 조사를 통해 신중하게 결정하시기 바랍니다.`,
    category: 'legal',
  },
  {
    question: 'StockMatrix는 금융 규제를 받나요?',
    answer:
      'StockMatrix는 금융투자협회에 등록되지 않은 참고용 정보 제공 서비스입니다. 투자자문업이나 투자일임업이 아니며, 매매 추천이나 투자 권유를 하지 않습니다. 15종의 기술적 지표를 코드로 계산한 분석 결과는 투자 판단을 위한 여러 참고 자료 중 하나로만 제공되며, 모든 투자 결정과 책임은 투자자 본인에게 있습니다. KOSPI, KOSDAQ 주식 투자는 원금 손실 위험이 있으니 신중하게 결정하시기 바랍니다.',
    category: 'legal',
  },
];
