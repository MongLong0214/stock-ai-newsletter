...
export const faqData: FAQItem[] = [
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    answer:
      'StockMatrix는 한국 주식 투자자를 위한 무료 이메일 뉴스레터 서비스입니다. AI가 RSI, MACD, 볼린저밴드 등 30개 기술적 지표로 분석한 KOSPI·KOSDAQ 3종목의 시장 분석과 투자 인사이트를 매일 오전 7시 30분 이메일로 제공합니다. 2024년 서비스 시작 이후 한국 개인 투자자들에게 참고용 무료 주식 정보를 제공하고 있습니다.',
    category: 'basic',
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    ...
    answer:
      '매일 평일 아침 7시 30분에 발송됩니다. 한국거래소(KRX) 정규장이 9시에 시작하기 때문에, 프리마켓 개장 30분 전인 7시 30분에 발송하여 투자자들이 장 시작 전 충분히 검토할 수 있도록 했습니다. KOSPI, KOSDAQ 투자를 위한 아침 루틴으로 활용할 수 있는 무료 뉴스레터입니다.',
    category: 'service',
  },
  {
    question: '뉴스레터 구독은 어떻게 하나요?',
    answer:
      '홈페이지에서 이메일 주소만 입력하시면 즉시 구독이 완료됩니다. 복잡한 회원가입 절차 없이 이메일 한 번으로 다음날부터 매일 아침 7시 30분에 AI 주식 분석 뉴스레터를 받아보실 수 있습니다. KOSPI와 KOSDAQ 종목의 무료 기술적 분석 정보를 받아보고 싶으시다면 지금 바로 구독해보세요.',
    category: 'service',
  },
  {
  ...
  },
  {
    ...
    answer:
      'StockMatrix의 주요 장점은 1) 완전 무료 (광고 없음), 2) 매일 오전 7시 30분 정시 발송 (장 시작 전), 3) AI가 30개 기술적 지표 종합 분석, 4) 이메일로 편리하게 수신, 5) 5초면 구독 완료, 6) 언제든 구독 취소 가능입니다.',
    category: 'service',
  },
  {
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // 테마 생명주기 분석 (TLI 기능 관련 - 4개)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    question: '테마 생명주기 분석이란 무엇인가요?',
    answer:
      'StockMatrix의 테마 생명주기 분석(TLI)은 반도체, 2차전지, AI, 방산 등 250개 이상의 주식 테마를 추적하여 각 테마가 현재 어떤 단계에 있는지 분석하는 기능입니다. 네이버 검색 관심도, 뉴스 빈도, 감성 분석, 주가 변동성을 종합하여 0~100점의 점수를 산출하고, 초기(Early) → 성장(Growth) → 정점(Peak) → 쇠퇴(Decay) → 휴면(Dormant)의 5단계 생명주기로 분류합니다. 테마별 상세 페이지에서 관련 종목, 뉴스, 생명주기 곡선을 확인할 수 있습니다.',
    category: 'service',
  },
  {
    question: '테마 분석은 어떻게 활용하나요?',
    answer:
      '테마 생명주기 분석은 시장의 흐름을 파악하는 데 활용할 수 있습니다. 성장(Growth) 단계의 테마는 관심도와 뉴스가 증가하는 추세를 보이며, 정점(Peak) 단계는 관심이 최고조에 달한 상태입니다. 쇠퇴(Decay) 단계는 관심이 줄어드는 시기이며, 초기(Early) 단계의 테마는 아직 시장의 주목을 받기 전입니다. 테마 목록 페이지(/themes)에서 전체 테마를 점수순으로 확인하고, 관심 있는 테마의 상세 페이지에서 관련 종목과 뉴스 동향을 참고하실 수 있습니다.',
    category: 'service',
  },
  {
  ...
  },
  {
    ...
    answer:
      '네, 테마 생명주기 분석은 완전 무료입니다. 별도의 회원가입이나 로그인 없이 누구나 테마 목록(/themes)과 상세 분석 페이지를 자유롭게 이용할 수 있습니다. 250개 이상의 테마 점수, 생명주기 단계, 관련 종목, 뉴스 헤드라인까지 모든 정보가 무료로 제공됩니다.',
    category: 'service',
  },
