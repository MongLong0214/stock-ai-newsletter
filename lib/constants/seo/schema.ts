...
export const schemaConfig: SchemaConfig = {
  websiteDesc: `한국 주식 투자자를 위한 무료 AI 주식 분석 뉴스레터 서비스입니다. AI가 RSI, MACD, 볼린저밴드 등 기술적 지표로 분석한 ${markets} ${stockCount}개 종목을 매일 ${deliveryTime} 이메일로 제공하며, 웹사이트에서는 200+ 테마 생명주기와 관련 종목 분석을 확인할 수 있습니다.`,
