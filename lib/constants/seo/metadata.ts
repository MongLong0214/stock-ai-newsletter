...
export const metadataConfig: MetadataConfig = {
  ...
  description: `한국 주식 투자자를 위한 무료 뉴스레터 서비스 — StockMatrix. 매일 ${deliveryTime} 시장 분석과 종목 인사이트를 이메일로 받아보는 투자 뉴스레터. AI가 ${indicatorCount}개 기술적 지표로 분석한 ${markets} ${stockCount}종목 정보와 250+ 테마 생명주기 추적을 무료 제공.`,
