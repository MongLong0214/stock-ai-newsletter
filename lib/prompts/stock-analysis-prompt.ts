...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔥 상위 3개 선정 (RSI 과매수 종목 철저 배제!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

🚨🚨🚨🚨🚨 최우선 필터링 (Zero Tolerance - 예외 절대 없음!) 🚨🚨🚨🚨🚨

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

STEP 1: RSI 과매수 종목 완전 배제 (치명적 결함 방지!)
────────────────────────────────────────────────

🔴🔴🔴 **과매수 구간(RSI > 70) 진입 종목 절대 추천 금지** 🔴🔴🔴

❌❌❌ **절대 금지**: RSI > 70인 종목은 무조건 제외! ❌❌❌

🚫 **과열된 종목 추천 = 투자자에게 손실을 안기는 행위!**
🚫 **추격매수 유도 = 고점 매수 = 큰 손실 위험!**
🚫 **과매수 구간 진입 종목 = 급락 리스크 극대화!**

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**금지 이유**:

1️⃣ **RSI > 70 = 과매수 구간 진입**
   → 이미 가격이 과도하게 상승한 과열 상태
   → 더 이상 상승 여력이 없는 위험 구간

2️⃣ **과열된 종목 추천 = 추격매수 유도**
   → 투자자가 고점에서 매수하게 만듦
   → 하락 전환 시 큰 손실 발생
...
1️⃣ **1차 확인**: 30개 종목 모두 RSI 값 확인
2️⃣ **2차 제외**: RSI > 70인 종목 → 즉시 후보군에서 완전 제외
3️⃣ **3차 검증**: RSI ≤ 70인 종목만 최종 선정 대상으로 진행

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

🔴🔴🔴 **절대 원칙 (ZERO TOLERANCE)** 🔴🔴🔴

✅ **RSI ≤ 70인 종목만** 최종 추천 가능
❌ **RSI > 70인 종목**은 overall_score가 **100점이라도** 절대 추천 금지!
❌ **예외 없음** - 단 하나의 RSI > 70 종목도 허용 안 됨
❌ **과열된 종목을 추격매수하게 만드는 것은 치명적 결함!**

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**핵심 메시지**:
**"과매수 구간(RSI > 70) 진입 종목은 절대 추천하지 않는다!"**
**"과열된 종목 추격매수 = 투자자 손실 = 서비스 신뢰도 파괴!"**

════════════════════════════════════════════════════════

STEP 2: 최종 3개 선정 (RSI ≤ 70 종목만!)
────────────────────────────────────────────────

🟢 **RSI ≤ 70 조건을 통과한 종목**들을 overall_score 내림차순으로 정렬한 후,
당신이 5일 내 10% 급등 가장 확신하는 상위 3개를 선택하세요.

제한 없음. 당신의 판단이 전부입니다.

⚠️⚠️⚠️ **3중 재확인 (필수!)** ⚠️⚠️⚠️

1️⃣ **최종 선정 전**: 3개 종목 모두 RSI ≤ 70인지 확인
2️⃣ **JSON 생성 전**: 3개 종목 모두 RSI ≤ 70인지 재확인
3️⃣ **출력 직전**: 3개 종목 모두 RSI ≤ 70인지 최종 확인

🚨 **만약 RSI > 70인 종목이 하나라도 포함되어 있다면**:
→ 즉시 해당 종목 제외
→ RSI ≤ 70인 다음 순위 종목으로 대체
→ 3개 모두 RSI ≤ 70 될 때까지 반복
