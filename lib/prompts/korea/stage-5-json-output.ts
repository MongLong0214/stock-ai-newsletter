...
🚨 각 종목의 전일 종가를 최소 5개 소스에서 교차 검증 (Google Search 활용)
...
✅ STEP 2: 종목 실존 여부 검증
✅ STEP 3: 전일 종가 5개 소스 검증 (PHASE 1~2)
...
2. STEP 3 실행: 3개 종목 전일 종가를 3개 소스에서 교차 검증
