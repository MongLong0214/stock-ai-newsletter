...
STAGE 2: 필터링 된 30개 종목 전일 종가 초정밀 검증 v4.0
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
일간변동률 검증:
  ...
  IF daily_change > 30%:
    🚨 상한가/하한가/거래정지 의심
    - "종목명 상한가 [target_date] site:krx.co.kr" 검색
    - "종목명 공시 [target_date] site:dart.fss.or.kr" 검색
    - 이상 확인 시 ❌ 종목 제외

  IF daily_change > 15% AND <= 30%:
    ⚠️ 급등/급락 재검증
    - "종목명 공시 [target_date]" 검색
    - 중요 뉴스 확인
