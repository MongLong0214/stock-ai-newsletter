...
| lib/tli/__tests__/composite.test.ts | compositeCompare (2-Pillar, 섹터패널티 0.85) | 14 |
| lib/tli/__tests__/prediction.test.ts | calculatePrediction (5 phase + confidence) | 17 |
...
### 2-Pillar 유사도 + Mutual Rank (v2.1)
| Pillar | 가중치 | 방법 |
|--------|--------|------|
| Feature Similarity | 동적 (0.40-1.00) | Mutual Rank 우선 → z-score 폴백 → 코사인 폴백 |
| Curve Similarity | 동적 (0.00-0.60) | RMSE shape (60%) + derivative Pearson (40%) |
